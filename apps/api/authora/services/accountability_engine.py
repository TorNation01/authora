...
MESSAGES = {
    "gentle": {
        "daily_reminder": "A small session today keeps the book alive. No pressure—just a little reminder.",
        "weekly_reminder": "You've been doing great. Your weekly goal is still within reach.",
        "missed_goal": "Life happens. Your goals are still here whenever you're ready. No judgment—just support.",
        "stuck": "Your book is still waiting for you. When you're ready, even fifteen minutes counts.",
        ...
        "resume_reminder": "Pick up where you left off. Your last chapter is waiting.",
        "chapter_target_reminder": "Chapter \"{chapter}\" is {words} words from its target. You've got this.",
        "section_reminder": "You were working on \"{chapter}\" recently. Keep the draft moving.",
        "missed_goal_recovery": "Life happens. Here's a gentle recovery plan whenever you're ready.",
    },
    "balanced": {
        ...
        "section_reminder": "You were working on \"{chapter}\". Pick up where you left off—one paragraph can reignite the flow.",
        "missed_goal_recovery": "You missed a goal. Here's a recovery plan to get back on track.",
    },
    "firm": {
        ...
        "section_reminder": "You were working on \"{chapter}\". Resume and write the next paragraph.",
        "missed_goal_recovery": "Goal missed. Recovery plan below. Stick to it.",
    },
    "coach": {
        ...
        "milestone_reminder": "Milestone ahead: {words} more words. Schedule a session today.",
        "streak_reminder": "{streak}-day streak. Don't break it—write something today.",
        "overdue_nudge": "Overdue. Recovery plan attached. Let's get back on track.",
        "finish_date_risk": "Finish date at risk. Increase daily output or adjust the deadline.",
        "resume_reminder": "Open \"{chapter}\" and write the next paragraph. Go.",
        "chapter_target_reminder": "Chapter \"{chapter}\": {words} words to target. One session.",
        "section_reminder": "You were working on \"{chapter}\". Pick up where you left off—one paragraph can reignite the flow.",
        "missed_goal_recovery": "You missed a goal. Here's your recovery plan. Small wins add up.",
    },
    "structured": {
        "daily_reminder": "[{date}] Daily target: {target} words.",
        "weekly_reminder": "[Week] Progress: {current}/{target} words.",
        "missed_goal": "Goal missed. Recovery plan generated. Follow the schedule below to realign.",
        "stuck": "No activity detected. Next action: open manuscript and write.",
        ...
        "resume_reminder": "Resume: {chapter}.",
    ...
    "minimal": {
        "daily_reminder": "A small session today keeps the book alive.",
        ...
        "stuck": "Even fifteen minutes counts.",
        "motivational": "One finished section beats another postponed perfect draft.",
        ...
        "overdue_nudge": "Your book is still waiting for you.",
        ...
        "section_reminder": "Keep the draft moving.",
