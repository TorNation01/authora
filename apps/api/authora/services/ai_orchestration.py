...
ACTION_DEFINITIONS: dict[str, ActionDefinition] = {
    ...
    "title_brainstorm": ActionDefinition(
        id="title_brainstorm",
        label="Title brainstorm",
        description="Brainstorm book or section titles.",
        fiction_prompt="Suggest 5-7 title options for this book/section. Mix evocative and literal:\n\n{context}",
        nonfiction_prompt="Suggest 5-7 title options that capture the content:\n\n{context}",
        general_prompt="Suggest 5-7 title options:\n\n{context}",
        uses_selection=False,
        uses_context=True,
        max_tokens=256,
    ),
    "blurb_copy": ActionDefinition(
        id="blurb_copy",
        label="Blurb copy",
        description="Write blurb or marketing copy.",
        fiction_prompt="Write a compelling back-cover blurb (2-3 paragraphs) for this book:\n\n{context}",
        nonfiction_prompt="Write a compelling blurb that sells this book:\n\n{context}",
        general_prompt="Write a blurb based on:\n\n{context}",
        uses_selection=False,
        uses_context=True,
        max_tokens=512,
    ),
    "summarize_section": ActionDefinition(
        id="summarize_section",
        label="Summarize section",
        description="Summarize a manuscript section.",
        fiction_prompt="Summarize this section in 1-2 paragraphs. Capture key events:\n\n{selection}",
        nonfiction_prompt="Summarize this section. Capture main points:\n\n{selection}",
        general_prompt="Summarize this section:\n\n{selection}",
        max_tokens=512,
    ),
    "freeform_creative": ActionDefinition(
        id="freeform_creative",
        label="Freeform creative",
        description="User-provided creative prompt.",
        fiction_prompt="{context}",
        nonfiction_prompt="{context}",
