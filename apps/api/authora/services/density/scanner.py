"""Story Density Engine scanner/orchestrator."""
...
from authora.models import Book, Chapter, DensityIssue, DensityScan, Project
...
async def run_density_scan(
    ...
    density_map = build_density_map(chapters=chapters_data, story_map=story_map)
    ...
    scan = DensityScan(
        ...
        manuscript_density_score=density_map.get("manuscript_density_score"),
        density_map_snapshot=density_map,
    )
    db.add(scan)
    await db.flush()
    ...
    for issue_data in all_issues:
        ...
        issue = DensityIssue(
            ...
            action_category=issue_data.get("action_category", "trim"),
