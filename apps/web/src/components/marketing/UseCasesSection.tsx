...
const USE_CASES = [
  ...
  { icon: PenLine, title: 'Ghostwriters', copy: 'Client projects, multiple books, professional workflow and export.' },
  { icon: Sparkles, title: 'First-time authors', copy: 'Step-by-step guidance from idea to finished manuscript.' },
