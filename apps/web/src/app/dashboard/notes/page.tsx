  ...
  return (
    <div className="p-6 lg:p-8 max-w-4xl">
      <PageHeader
        ...
        description="Your research, ideas, and scratch notes. Pick a project to get started."
      />
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description="Create a project and book first. Notes live with your projects."
